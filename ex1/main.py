...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default='/home/jahyeok/Desktop/hdd2_sl/jahyeok/urop/baseline_checkpoint/check_point', help='')
...
if __name__ == '__main__':
    ...
    if args.train:
        #train mode
        train_data = dataset.TrainDataset(test_behavior, args.data_pth, args.negative_cnt)
        ...
        # behavior graph
        model = LightGCN(args, device, args.layers, N_user+1, N_item+1, matrix_list[0][args.behaviors.index(args.behv)]).to(device)
        ...
        # model load
        model_pth = os.path.join(args.model_path, args.data_name, args.behv, str(args.lr), str(args.layers), 'model' + '.pth')
